...
namespace InfinityBooksDemo.Helper
{
    ...
    {
        public async Task<HttpResponseMessage> StoreGoogleUserData(string code)
        {
          ...
          //  QueryHelper<UserProfile> userProfileQueryHelper = new QueryHelper<UserProfile>();
            ...
            var requestUrl = $"oauth2/v4/token?code={code}&client_id=175142243483-4p6n97bgei5s1ueenmufdj09md20ha4r.apps.googleusercontent.com&client_secret=gVFIilYg9lyBXStAfiv0QAJ2&grant_type=authorization_code&redirect_uri=http://localhost:54418/Login/UserGoogleLoginHelper&state=abcdef";
            ...
            var res= new HttpResponseMessage(HttpStatusCode.InternalServerError) { Content = new StringContent(JsonConvert.SerializeObject(obj))};
            return res;
            #endregion
